...
const inputForm = (
  ...
  const populateInput = () => {
    ...
    if (editPrio) {
      ...
      setAttributes(oldPrio, {
        selected: "true",
        hidden: "true",
        disabled: "true",
      });
      oldPrio.textContent =
        editPrio.charAt(0).toUpperCase() + editPrio.slice(1);
    ...
    if (projId) {
      ...
      setAttributes(pageProjectOption, {
        selected: "true",
        hidden: "true",
        disabled: "true",
        value: projId,
      ...
      pageProjectOption.textContent =
        pageProject.name.charAt(0).toUpperCase() + pageProject.name.slice(1);
    ...
    if (editParent && editParent !== "None") {
      ...
      oldParentName.textContent =
        oldParent.name.charAt(0).toUpperCase() + oldParent.name.slice(1);
